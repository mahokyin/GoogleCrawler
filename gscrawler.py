'''
Editor : Joe Ma
Description: Using existing .py to revise and add some custom function
...
class GoogleSearchCrawler(object):
    '''
        Class for constructing and parsing the url created from Google search.
    '''

    # To show how many result the program extracts
    count = 0
    # Array showing all the names of website
    webNameArray = []
    # Array showing all sites of name
    websiteArray = []
        ...
        for n in dom_object:
            try:
                ...
                if re.search('q=(.*)&(amp;)?sa',n.content):
                    ...
                    if self.print_parse_results:
                        #print temp_link_data #Link
                        self.websiteArray.append(temp_link_data)
                ...
                if self.print_parse_results:
                    #print temp_desc #Name
                    self.webNameArray.append(temp_desc)
                ...
                continue
            self.count = self.count + 1  # Keep counting
